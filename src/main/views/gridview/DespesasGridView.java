...
public class DespesasGridView extends GridView<Despesa> {
    ...
    public DespesasGridView(GridPane animaisGrid, int numColumns, List<Despesa> items, Pane contentFather) {
    ...
    @Override
    public Node createGridItem(Despesa despesa, int column, int row) {
